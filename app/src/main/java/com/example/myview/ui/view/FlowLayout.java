...
public class FlowLayout extends ViewGroup {
    ...
    class Line {
        ...
        public void LayoutView(int l, int t) {
            ...
            Log.i("FlowLayout", "surplusWidth:" + surplusWidth + ",count:" + count + ",l:" + left + ",t:" + top);
            if (surplusWidth >= 0) {
                for (int i = 0; i < count; i++) {
...
//                    int topOffset = mHeight - childHeight;
//                    Log.i("ygq", "index:" + i + ",topOffset:" + topOffset+",mHeight:"+mHeight+",childHeight:"+childHeight);
//                    if (topOffset < 0) {
//                        topOffset = 0;
//                    }
